Contributing to Escrow Core
============================

The Escrow Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Escrow Core project, and is not to be
confused with overall Escrow Network Protocol consensus changes.

Whether a pull request is merged into Escrow Core rests with the project merge
...
Patches that change Escrow consensus rules are considerably more involved than
...
Where a patch set proposes to change the Escrow consensus, it must have been
...
The project leader is the release manager for each Escrow Core release.
