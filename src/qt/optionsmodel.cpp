...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::ESCO);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeEscrowAmount"))
        SoftSetArg("-anonymizeescrowamount", settings.value("nAnonymizeEscrowAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in escrow.cpp during shotdown to also remove the window positions
