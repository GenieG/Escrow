...
/* Escrow GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Escrow"
#define QAPP_ORG_DOMAIN "escrow.cc"
#define QAPP_APP_NAME_DEFAULT "Escrow-Qt"
#define QAPP_APP_NAME_TESTNET "Escrow-Qt-testnet"
