                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Escrow Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Escrow address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and escrow: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zESCO"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Escrow Core"), this);
    aboutAction->setStatusTip(tr("Show information about Escrow Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Escrow"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Escrow addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Escrow addresses"));
    ...
    openAction->setStatusTip(tr("Open a Escrow: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Escrow Core help message to get a list with possible Escrow command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Escrow Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Escrow Core"); // default title
