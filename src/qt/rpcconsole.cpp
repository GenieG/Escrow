                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzESCOPathCustom = GetArg("-zpivbackuppath", "");
    ...
    if(!strzESCOPathCustom.empty()) {
        ui->wallet_customzpivbackuppath->setText(QString::fromStdString(strzESCOPathCustom));
        ui->wallet_customzpivbackuppath_label->setVisible(true);
        ui->wallet_customzpivbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzESCOPathCustom.empty()) && nCustomBackupThreshold > 0) {
