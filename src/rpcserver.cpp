...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Escrow features */
        {"escrow", "masternode", &masternode, true, true, false},
        {"escrow", "listmasternodes", &listmasternodes, true, true, false},
        {"escrow", "getmasternodecount", &getmasternodecount, true, true, false},
        {"escrow", "masternodeconnect", &masternodeconnect, true, true, false},
        {"escrow", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"escrow", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"escrow", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"escrow", "masternodecurrent", &masternodecurrent, true, true, false},
        {"escrow", "masternodedebug", &masternodedebug, true, true, false},
        {"escrow", "startmasternode", &startmasternode, true, true, false},
        {"escrow", "createmasternodekey", &createmasternodekey, true, true, false},
        {"escrow", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"escrow", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"escrow", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"escrow", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"escrow", "getmasternodescores", &getmasternodescores, true, true, false},
        {"escrow", "mnbudget", &mnbudget, true, true, false},
        {"escrow", "preparebudget", &preparebudget, true, true, false},
        {"escrow", "submitbudget", &submitbudget, true, true, false},
        {"escrow", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"escrow", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"escrow", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"escrow", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"escrow", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"escrow", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"escrow", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"escrow", "checkbudgets", &checkbudgets, true, true, false},
        {"escrow", "mnsync", &mnsync, true, true, false},
        {"escrow", "spork", &spork, true, true, false},
        {"escrow", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> escrow-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:12928/\n";
}
