...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Escrow Core escrow-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  escrow-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded escrow transaction") + "\n" +
                               "  escrow-tx [options] -create [commands]   " + _("Create hex-encoded escrow transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded escrow transaction
