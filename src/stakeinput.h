...
#ifndef Escrow_STAKEINPUT_H
#define Escrow_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZESCO() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zESCOStake can take two forms
...
public:
    ...
    bool IsZESCO() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZESCO() override { return false; }
};


#endif //Escrow_STAKEINPUT_H
